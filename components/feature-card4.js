    ...
    <>
      <div className="feature-card4-container">
        <div className="feature-card4-feature-card">
          ...
          <h2 className="feature-card4-infrastructure">{props.title1}</h2>
          <span className="feature-card4-feature">{props.description}</span>
          <span className="feature-card4-read-more">{props.action}</span>
        </div>
      </div>
      <style jsx>
        {`
