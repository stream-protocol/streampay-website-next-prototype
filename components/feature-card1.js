  ...
  return (
    <>
      <div className={`feature-card1-feature-card ${props.rootClassName} `}>
        ...
        <h2 className="feature-card1-pay-links">{props.title1}</h2>
        <span className="feature-card1-feature">{props.description}</span>
        <span className="feature-card1-read-more">{props.action}</span>
      </div>
      <style jsx>
        {`
